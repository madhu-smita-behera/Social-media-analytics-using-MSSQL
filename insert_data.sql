--13 tables present in socialmedia database
--bookmarks, comment_likes, comments, follows, hashtag_follow, hashtags, login
--photos, post, post_likes, post_tags, users, videos
